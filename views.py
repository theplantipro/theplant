...
def am_write_to_spread(date1,date2):
   ...
   for obj in objects:
      ...
      sheet.write(i+3,1,'Measure ppm')
      sheet.write(i+3,2,'Actual ppm')
      sheet.write(i+3,3,'Measure ppm')
      sheet.write(i+3,4,'Actual ppm')
      sheet.write(i+4,1,obj.system)
